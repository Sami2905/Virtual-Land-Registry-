...
function HowItWorks() {
  useEffect(() => {
    ...
    animateOnScroll('.howitworks-step', {
  ...
  return (
    <section style={{ background: 'rgba(18,20,34,0.98)', padding: '5rem 0', width: '100vw' }}>
      <MaxWidthContainer>
        <motion.h2
        ...
        >
          <Badge style={{ marginRight: 12, background: '#23233a', color: '#3b82f6' }}>How It Works</Badge>
          ...
          {steps.map((step, i) => (
            ...
            >
              <Card style={{
                ...
                <span style={{ fontSize: '2.5rem', marginBottom: 8 }}>{step.icon}</span>
                <span style={{
                ...
                <div style={{ fontWeight: 700, fontSize: '1.18rem', color: '#fff', marginBottom: 6, textAlign: 'center' }}>{step.title}</div>
                <div style={{ color: '#A0A0A0', fontSize: '1.05rem', textAlign: 'center', marginBottom: 8 }}>{step.desc}</div>
              </Card>
            </motion.div>
          ))}
        </div>
        <div style={{ display: 'flex', justifyContent: 'center', marginTop: '3.5rem' }}>
          <Button style={{ fontSize: '1.15rem', padding: '1.1rem 2.6rem', borderRadius: 999, fontWeight: 700 }}>
            Get Started
          </Button>
        </div>
      </MaxWidthContainer>
