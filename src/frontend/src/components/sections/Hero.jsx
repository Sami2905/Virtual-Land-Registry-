    ...
    <section className="w-full min-h-screen flex items-center justify-center bg-gradient-to-br from-[#0a0a0a] via-[#23233a] to-[#3b82f6] relative overflow-hidden">
      <MaxWidthContainer>
        ...
        >
          ...
          >
            Securely buy, sell, and manage virtual real estate. Build your digital empire in the metaverse.
          </motion.p>
          <motion.div
            ref={ctaRef}
          ...
          >
            ...
            <GlowButton onClick={onGetStarted} className="bg-transparent border border-accent-blue text-white shadow-none">Mint Land</GlowButton>
          </motion.div>
          <motion.div
          ...
          >
            <TiltCard className="w-80 mx-auto p-0 bg-gradient-to-br from-[#23233a] to-accent-blue">
              <div className="p-8 flex flex-col items-center">
                ...
                <div className="font-bold text-2xl text-white mt-2">Discover Digital Lands</div>
                <div className="text-accent-blue/80 text-base mt-2 text-center">Browse, select, and own unique parcels in the metaverse.</div>
              </div>
            </TiltCard>
          </motion.div>
        </motion.div>
